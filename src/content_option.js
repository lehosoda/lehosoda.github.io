...
const introdata = {
    ...
    your_img_url: require("../src/assets/images/pfp.png"),
};
...
const dataabout = {
    ...
    Being an interdisciplinary academic, my priorities are building relationships with my peers, giving back to the communities that have allowed me to be successful, and embracing new learning opportunities within various technology-based industries.<br> <br> 
    I'm currently looking for roles in the <b class="highlight">project management</b>, 
    <b class="highlight">data analysis</b>, or <b class="highlight">solutions architecture</b>, 
    but I'm open to taking on other roles as well! <br> <br> 
    In my free time, you can find me exploring the Seattle/Hawai'i foodie scenes (I'm currently working towards Yelp Elite Status!), scrapbooking, brushing up on my Japanese, or taking film photos on my Konica Auto S <br> <br> 
    Feel free to take a look at my <b class="highlight"><a href="https://drive.google.com/file/d/1znxpsQbYo2ZPINNZDXb0iZX22ff-9P1e/view?usp=sharing" class="highlight" target="_blank">resume</a></b> <3`,
};
const worktimeline = [{
...
const dataportfolio = [{
    ...
    {
        img: require("../src/assets/images/personalweb.png"),
...
const socialprofils = {
    linkedin: "https://www.linkedin.com/in/loganhosoda/",
    github: "https://github.com/lehosoda",
